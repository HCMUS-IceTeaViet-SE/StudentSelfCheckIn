...
public class Timetable  implements java.io.Serializable {
    ...
    public Timetable() {
        this.timeTableId = UUID.randomUUID().toString().substring(0,9);
    }
    public Timetable(ClassSubject classsubject, Date startDate, Date endDate, Integer weekCount, String weekDay, Date startTime, Date endTime, String classRoom) {
       this.timeTableId = UUID.randomUUID().toString().substring(0,9);
